...
```
    ...
    <div>
        ...
        <span id="c1e067d1-af3b-4c80-805b-9f6a0d402690">Loading BokehJS ...</span>
    </div>

    Unable to display output for mime type(s): application/javascript, application/vnd.bokehjs_load.v0+json

  <div id="bc21911a-7d10-488f-9981-448b1a9c19ca" data-root-id="p4224" style="display: contents;"></div>
